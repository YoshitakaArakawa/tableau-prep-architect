...
Reads work/<session>/reports/publish-manifest.json (written by tableau-prep-builder and
enriched by tableau-prep-deployer) and emits a pairs.json that tableau-pds-comparator's
