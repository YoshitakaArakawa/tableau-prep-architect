...
8. 1〜7 で不整合が見つかったら、ステップ配置・削除提案・対応表・DAG を是正してから plan を出力する
...
| 長いフロー (30+ ステップ) | `work/<date>/reports/analysis-<flow>.md` / `work/<date>/reports/decomposition-plan-<flow>.md` ファイル + 会話にサマリ |
