...
| `output_path` | ✅ | `flow-summary.md` / `deploy-context.md` の出力先 (典型: `work/<yyyymmdd>_<tag>/`) |
...
加えて、出力先の `flow-summary.md` のパス（典型的には `work/<yyyymmdd>_<summary>/flow-summary.md`）。
